/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 08917e1cbbad8afa7ba95fa0b02f26b3)
// Runtime types generated with workerd@1.20260828.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	...
	LOYVERSE_API_TOKEN: string;
	LOYVERSE_API_TOKEN_2: string;
	FONNTE_TOKEN: string;
	WA_NUMBER: string;
